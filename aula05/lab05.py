...
plt.subplot(122), plt.hist(img_gray.ravel(), 256, [0, 256], color="k")
plt.title("Gray Histogram")

# Imagem em tons de cinza equalizada
plt.subplot(123), plt.imshow(img_equalized, cmap="gray")
plt.axis("off")
plt.title("Equalized")

# Gráfico do histograma equalizado (PIXELS x INTENSIDADE)
plt.subplot(124), plt.hist(img_equalized.ravel(), 256, [0, 256], color="k")
